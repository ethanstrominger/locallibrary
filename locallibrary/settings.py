...
SECRET_KEY = "django-insecure-&f$_-=)$96917^itzvd=#7em!d1@mdoyk)y^zm%$7!q&3+-*_0"
...
MIDDLEWARE = [
    "django.contrib.sites.middleware.CurrentSiteMiddleware",    "django.middleware.security.SecurityMiddleware",
